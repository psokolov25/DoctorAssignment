 ...
 *
 * <p>Нужна для тех инсталляций Orchestra, где простого REST-вызова assign/transfer недостаточно,
 * и перед мутациями требуется отдельный шаг старта/привязки сессии рабочего места.</p>
 */
public interface OperatorContextActivationGateway {
     ...
     *
     * <p>Если activation в конфигурации отключен, реализация должна завершиться без ошибки.</p>
     */
