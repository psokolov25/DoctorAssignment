 ...
 *
 * <p>Значения enum отражают не только сырые события Orchestra, но и внутренние составные
 * trigger-ы сервиса, такие как {@link #USER_SESSION_READY} и {@link #WORK_PROFILE_EXPANDED}.
 * Это позволяет в логах и инцидентах быстро понять, какой именно путь привел к mutating
 * workflow.</p>
 */
