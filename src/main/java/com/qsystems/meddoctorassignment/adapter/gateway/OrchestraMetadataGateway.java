...
/**
 * Абстракция над чтением справочных данных Orchestra, необходимых для принятия решений
 * о назначении врача визиту.
 *
 * <p>Через этот gateway слой домена и кэширования получает только стабильные справочные
 * сущности: отделения, услуги, очереди, рабочие профили и точки обслуживания.</p>
 */
