...
public class ConfigurableVisitWorkflowGatewayTest {
  ...
  void extractsNoStartedServicePointSessionStateFromJsonResponse() {
    ...
    Assertions.assertEquals(
        ...
        ConfigurableVisitWorkflowGateway.extractUserState(body));
  }
  ...
  void extractsCurrentVisitServiceIdFromJsonResponse() {
    String body =
        "{\"visitId\":172162,\"userState\":\"INACTIVE\",\"currentVisitService\":{\"serviceId\":4}}";

    Assertions.assertEquals(
        Integer.valueOf(4), ConfigurableVisitWorkflowGateway.extractCurrentVisitServiceId(body));
  }

  @Test
  void treatsAssignAsEffectivelyAppliedWhenCurrentVisitServiceMatchesRequestedService() {
    Assertions.assertTrue(
        ConfigurableVisitWorkflowGateway.isAssignEffectivelyApplied(Integer.valueOf(4), 4));
    Assertions.assertFalse(
        ConfigurableVisitWorkflowGateway.isAssignEffectivelyApplied(Integer.valueOf(72), 4));
