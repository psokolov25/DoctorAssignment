 ...
 *
 * <p>Используется как fallback-механизм, когда событие Orchestra не содержит полный набор полей для
 * однозначного определения врача, точки обслуживания или рабочего профиля.
 */
