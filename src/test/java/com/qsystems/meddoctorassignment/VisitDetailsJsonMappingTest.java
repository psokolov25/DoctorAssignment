...
public class VisitDetailsJsonMappingTest {
    ...
    void mapsOrchestraVisitPayloadWithUnservedVisitServices() throws Exception {
        String json = "{\"id\":172082,\"unservedVisitServices\":[{\"serviceId\":5,\"serviceInternalName\":\"Терапевт\"},{\"serviceId\":7,\"serviceInternalName\":\"Оккулист\"},{\"serviceId\":4,\"serviceInternalName\":\"Хирург\"},{\"serviceId\":6,\"serviceInternalName\":\"Стоматолог\"}],\"parameterMap\":{\"currentQueueOrigId\":98}}";
        ...
        Assertions.assertEquals(Integer.valueOf(5), visitDetails.getUnservedServices().get(0).getServiceId());
    ...
    void mapsCurrentVisitServiceIdFromNestedCurrentVisitServiceObject() throws Exception {
        String json = "{\"id\":172161,\"currentVisitService\":{\"serviceId\":4},\"parameterMap\":{\"currentQueueOrigId\":98}}";
